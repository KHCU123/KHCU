	...
	<tr height="30">      
		<td colspan="4" align="right">
			<input type="button" value="수정"
				onclick="document.location.href='comNoticeModifyForm.khcu?num=${article.num}&pageNum=${pageNum}'">
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" value="삭제"
				onclick="document.location.href='comNoticeDeleteForm.khcu?num=${article.num}&pageNum=${pageNum}'">
			&nbsp;&nbsp;&nbsp;&nbsp;
