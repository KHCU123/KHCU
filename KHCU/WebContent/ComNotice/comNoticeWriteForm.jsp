...
<center><b> 공지사항 작성 </b>
<br>
<form method="post" name="writeForm" action="comNoticeWritePro.khcu" onsubmit="return writeCheck()">
...
<table id="customers" width="400" border="1" cellspacing="0" cellpadding="0"  align="center">
	...
	<tr>      
		<td align="center" colspan="2"> 
			...
			<input type="button" value="목록" OnClick="window.location='comNoticeList.khcu'">
		</td>
	</tr>
</table>
