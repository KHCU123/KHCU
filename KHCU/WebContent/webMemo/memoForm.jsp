...
<form method="post" action="memoPro.khcu" name="form1" id="form1" onSubmit="return checkIt()">
  <table border="1" align="center">
    <tr> 
    <td colspan="4" height="39" align="center">
       <font size="+1" ><b> 쪽지보내기 </b></font></td>
    </tr>    
    <tr>
       <td>보내는 사람</td><td><input type="text" name="sender" value="${sessionScope.memId}" size="20" readonly /></td>
       <td>쪽지 유형</td><td><input type="text" name="memoType" value="normal"  /></td>
    </tr>
    <tr>
