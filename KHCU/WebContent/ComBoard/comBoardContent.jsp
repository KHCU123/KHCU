	...
	<tr height="30">      
		<td colspan="4" align="right">
			<input type="button" value="수정"
				onclick="document.location.href='comBoardModifyForm.khcu?num=${article.num}&pageNum=${pageNum}'">
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" value="삭제"
				onclick="document.location.href='comBoardDeleteForm.khcu?num=${article.num}&pageNum=${pageNum}'">
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" value="목록" onclick="document.location.href='comBoardList.khcu?pageNum=${pageNum}'">
		</td>
	</tr>
</table>
</form>
