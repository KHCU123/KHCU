...
<body>
<center> <b> 비밀번호 찾기 &nbsp; <input type="button" value="학번(아이디) 찾기" onclick="javascript:location='findIdForm.khcu'"></b><br>
<br><br>
<form action="findPwPro.khcu" method="post">
<table width="400" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="100" height="30" align="right"> 학번(아이디) </td>
		<td width="200" height="30" align="center"><input type="text" name="findNum"></td>
	</tr>
	<tr>
