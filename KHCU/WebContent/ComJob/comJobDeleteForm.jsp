...
<center><b> 취업정보 삭제 </b>
<br>
<form method="POST" name="deleteForm"  action="comJobDeletePro.khcu?pageNum=${pageNum}" onsubmit="return pwCheck()"> 
<input type="hidden" name="num" value="${num}">

<table id="customers" border="1" align="center" cellspacing="0" cellpadding="0" width="360">
	<tr height="30">
		<td align=center><b> 취업정보 글 삭제를 위해 비밀번호를 입력해 주시기 바랍니다 </b></td>
	</tr>
	<tr height="30">
