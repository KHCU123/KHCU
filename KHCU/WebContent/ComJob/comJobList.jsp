...
<table width="700">
	<tr>
		<td align="right">
			<a href="comJobWriteForm.khcu">글쓰기</a>
		</td>
	</tr>
</table>
...
<table id="customers" border="1" width="700" cellpadding="0" cellspacing="0" align="center"> 
	...
	<tr height="30">
		...
		<td  width="400" >
			&nbsp;<a href="comJobContent.khcu?num=${article.num}&pageNum=${currentPage}"> ${article.title} </a> 
		</td>
...
<c:if test="${count > 0}">
	...
	<c:if test="${startPage > 10}">
		<a href="comJobList.khcu?pageNum=${startPage - 10 }">[이전]</a>
	</c:if>

	<c:forEach var="i" begin="${startPage}" end="${endPage}">
		<a href="comJobList.khcu?pageNum=${i}">[${i}]</a>
	</c:forEach>

	<c:if test="${endPage < pageCount}">
		<a href="comJobList.khcu?pageNum=${startPage + 10}">[다음]</a>
	</c:if>
</c:if>
